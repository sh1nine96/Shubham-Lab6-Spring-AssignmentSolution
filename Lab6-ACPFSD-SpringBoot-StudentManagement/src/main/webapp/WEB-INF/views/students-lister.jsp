...
<body>
	...
	<div class="container">
		...
		<h3>Listing all the Students</h3>
		<hr>
		...
		<form class="form-inline">
			...
			<!-- Add a button -->
			<c:url var="addUrl" value="/student/begin-add" />
			<a href="${addUrl}"
				...
				<c:forEach items="${students}" var="tempStudent">
					<tr>
						...
						<td>
							...
							<c:url var="updateUrl" value="/student/begin-update?studentId=${tempStudent.id}" />
							 <a href="${updateUrl}"
